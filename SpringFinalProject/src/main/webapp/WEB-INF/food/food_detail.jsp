...
<div class="wrapper row3 rows">
     ...
     <div class="row" id="food_reply">
      ...
      <c:if test="${sessionScope.id!=null }">
       <table class="table">
         <tr>
           <td>
            <textarea rows="5" cols="52" style="float: left" v-model="msg"></textarea>
 ...
 new Vue({
	 el:'#food_reply',
 	 ...
 	 mounted:function(){
 		 let _this=this;
 		 axios.get('http://localhost/web/reply_list.do',{
 			 params:{
 				 fno:this.fno,
 				 type:this.type
 			 }
 ...
 new Vue({
	...
	methods:{
		addScript:function(){
			...
			script.src='http://dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=1b3cee0c7ab68fc8a8f7906e38fdf071&libraries=services';
