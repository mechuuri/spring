    ...
    new Vue({
    	...
    	mounted:function(){
			...
			$('#keyword').keyup(function(){
				let k=$(this).val();
				$('#user-table > tbody > tr').hide(); // tr태그 전체 지우기
				let temp=$('#user-table > tbody > tr > td:nth-child(5n+3):contains("'+k+'")')// 제목에서 찾는다
				$(temp).parent().show(); // 포함된 단어만 보여줘. parent는 tr. tr부터 데이터 보여주라 ㅋ
				})
